...
public class Count_the_Number_of_matching_characters_in_a_pair_of_strings_GotHub{
  ...
  //        matchCharacter(str1, str2);
          System.out.println("the total matching character is : " + matchCharacter(str1, str2));
